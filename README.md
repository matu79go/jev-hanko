...
速くて安い LLM と実測比較したリポジトリです。 / [English demo](https://matu79go.github.io/jev-hanko/sort.html?lang=en)
...
| モデル | 1 ページの待ち時間(500 回の中央値) | 1,000 ページあたり | 見つけた率 | 的中率 | F1 |
|---|---|---|---|---|---|
| **Jev(41 問を 1 回で)** | **0.37 秒** | $0.117 | 68.3% | 41.9% | 0.519 |
| Llama 3.1 8B(最速プロバイダ) | 0.53 秒 | $0.074 | 55.4% | 10.8% | 0.180 |
| Qwen 3.7 Flash | 0.78 秒 | **$0.060** | 65.7% | 59.3% | **0.623** |
| gpt-oss-20b(最速プロバイダ) | 0.87 秒 | $0.175 | 59.5% | 52.2% | 0.556 |
| Gemini 2.5 Flash-Lite(番号だけ) | 0.88 秒 | $0.206 | 73.9% | 21.7% | 0.335 |
| Claude Haiku 4.5 | 1.35 秒 | $2.143 | 79.1% | 37.4% | 0.508 |
| Gemini 2.5 Flash-Lite(41 項目すべて) | 1.38 秒 | $0.322 | 72.0% | 51.0% | 0.597 |
| Claude Sonnet 5(200 ページ) | 2.18 秒 | $6.068 | 77.0% | 52.1% | 0.622 |

- 測り方: 1 ページ = 1 回の API 呼び出し。各モデルを 500 回ずつ呼び(Sonnet 5 は 200 回)、1 回ごとに「リクエスト送信から応答受信まで」の秒数と請求額を記録。待ち時間はその中央値
